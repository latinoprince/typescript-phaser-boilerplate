...
module Namespace.State {
    export class Level4 extends Phaser.State {
		...
		localShip:Phaser.Sprite
		remoteShip:Phaser.Sprite

		bullets:Phaser.Group

		scoreText:Phaser.Text
		livesText:Phaser.Text
		peerIdText:Phaser.Text
		...
		preload(){
			...
			let rndGenerator = new Phaser.RandomDataGenerator();
			let peerId = 'player-' + rndGenerator.between(1,100);
		...
		create(){
			...
			let input = (<PhaserInput.InputFieldGame>this.game).add.inputField(10,90,
						{
							font: '18px Arial',
							fill: '#212121',
							fillAlpha: 0.5,
