...
(function (Namespace) {
    ...
    (function (State) {
        var Level2 = (function (_super) {
            ...
            Level2.prototype.releaseBall = function () {
                if (this.ballOnPaddle) {
            ...
            Level2.prototype.ballLost = function () {
                this.lives--;
            ...
            Level2.prototype.gameResized = function (width, height) {
            ...
            Level2.prototype.ballHitBrick = function (_ball, _brick) {
                _brick.kill();
                this.score += 10;
            ...
            Level2.prototype.ballHitPaddle = function (_ball, _paddle) {
                var diff = 0;
