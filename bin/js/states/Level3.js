...
(function (Namespace) {
    ...
    (function (State) {
        var Level3 = (function (_super) {
             ...
             * Generates an enemy
             */
            Level3.prototype.generateEnemy = function () {
             ...
             */
            Level3.prototype.enemyHitPlayer = function (player, enemy) {
             ...
             */
            Level3.prototype.goToMainMenu = function () {
             ...
             */
            Level3.prototype.enemyHitBullet = function (bullet, enemy) {
                if (this.enemies.getIndex(enemy) > -1)
                    this.enemies.remove(enemy);
                enemy.kill();
                bullet.kill();
