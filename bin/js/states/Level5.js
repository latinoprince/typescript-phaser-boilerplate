    ...
    (function (State) {
        var Level5 = (function (_super) {
            ...
            Level5.prototype.create = function () {
                ...
                var upgradeButtons = state.upgradePanel.addChild(state.game.add.group());
                ...
                this.monsterNameText = this.monsterInfoUI.addChild(this.game.add.text(0, 0, this.currentMonster.name, {
            ...
            Level5.prototype.onDPS = function () {
            ...
            Level5.prototype.onUpgradeButtonClick = function (button) {
                //alert("here...");
            ...
            Level5.prototype.onClickCoin = function (coin) {
                if (!coin.alive) {
                    return;
                }
            ...
            Level5.prototype.onKilledMonster = function (monster) {
            ...
            Level5.prototype.onRevivedMonster = function (monster) {
                monster.position.set(this.game.world.centerX + 100, this.game.world.centerY + 50);
                // update the text display
                this.monsterNameText.text = monster.details.name;
                this.monsterHealthText.text = monster.health + 'HP';
            };
            Level5.prototype.onClickMonster = function (monster, pointer) {
